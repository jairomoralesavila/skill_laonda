...
STREAMS = [
  {
    "token": '1',
    "url": 'https://sp3.servidorrprivado.com:10975/',
    "metadata": {
      "title": 'La Onda México',
      "subtitle": 'Ponte en onda',
      "art": {
        "sources": [
          {
            "contentDescription": 'example image',
            "url": 'https://firebasestorage.googleapis.com/v0/b/mix-tv-streaming.appspot.com/o/la_onda.png?alt=media&token=b0897e0a-ca4e-494e-9cc8-3b3545294efd',
            "widthPixels": 512,
            "heightPixels": 512
          }
        ]
      ...
      "backgroundImage": {
        "sources": [
          {
            "contentDescription": 'example image',
            "url": 'https://firebasestorage.googleapis.com/v0/b/mix-tv-streaming.appspot.com/o/background.png?alt=media&token=e124a36d-cdb9-4bba-88ec-5db9631b0c64',
            "widthPixels": 1200,
            "heightPixels": 800
          }
        ]
